...
create table persona (
	...
	condicion		tinyint,						# alumno =0; exalumno=1; familiar =2; profesor=3; exprofesor=4; colaborador=5
...
create table alumno (
	fecha_inicio	date,
	#tasa			numeric (5,2),
    nivel			enum('1º Primaria','2º Primaria','3º Primaria','4º Primaria','5º Primaria','6º Primaria','1º ESO','2º ESO','3º ESO','4º ESO','1º Bachillerato','2º Bachillerato','Ciclo','Universidad','Otro'),
	persona_ID		int,
	foreign key (persona_ID) references persona(persona_ID)
);
